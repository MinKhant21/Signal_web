              ...
              <div class="p-8  mx-auto">
                ...
                <form action="" >
                  <div className=' '>
                    ...
                    <input type="text" className='border mt-2 rounded-sm shadow-md  w-full px-3 py-1 ' placeholder=' Enter Your Name'  />
                  </div>
                  <div className=' mt-4 '>
                    <label htmlFor="" className=''>Phone</label>
                    <input type="text" className='border mt-2 rounded-sm shadow-md  w-full px-3 py-1 ' placeholder=' Enter Your Phone'  />
                  </div>
                  <div className=' mt-4 '>
                  ...
                  <div className=' mt-5'>
                    <input type="submit" value="Login" className='border mt-2   w-full   text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2'/>
                  </div>
                </form>
              </div>
            </div>
