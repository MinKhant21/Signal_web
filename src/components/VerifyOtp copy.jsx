        ...
        <div className='mb-4'>
            ...
            <div className='flex justify-center items-center gap-5'>
                <div id="otp" className="flex flex-row justify-center text-center px-2 mt-5">
                    <input className="m-2 border h-10 w-10 text-center form-control rounded cursor-auto" type="text" onKeyDown={e=>setOtp(prevState => prevState+e.target.value)}  maxlength="1" /> 
                    <input className="m-2 border h-10 w-10 text-center form-control rounded" type="text" onKeyDown={e=>setOtp(prevState => prevState+e.target.value)}  maxlength="1" /> 
                    <input className="m-2 border h-10 w-10 text-center form-control rounded" type="text"onKeyDown={e=>setOtp(prevState => prevState+e.target.value)}  maxlength="1" /> 
                    <input className="m-2 border h-10 w-10 text-center form-control rounded" type="text"onKeyDown={e=>setOtp(prevState => prevState+e.target.value)}  maxlength="1" /> 
                    <input className="m-2 border h-10 w-10 text-center form-control rounded" type="text"onKeyDown={e=>setOtp(prevState => prevState+e.target.value)}  maxlength="1" /> 
                    <input className="m-2 border h-10 w-10 text-center form-control rounded" type="text"onKeyDown={e=>setOtp(prevState => prevState+e.target.value)}  maxlength="1" /> 
